...
//         <ul className="list-disc pl-5">
//           {Object.entries(rlsCart).map(([sNo, details]) => (
//             <li key={sNo} className="mb-1">
//               <span className="font-semibold">RLS Item {sNo}:</span> Quantity:{" "}
//               {details.qty}, Cost: {details.cost}, Level: {details.level},
