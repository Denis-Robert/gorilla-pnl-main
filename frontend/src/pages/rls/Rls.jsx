...
//                 <th
//                   key={i}
//                   className="py-2 px-4 border-b border-gray-300 min-w-[100px]"
//                 >
//                   M{i + 1}
//                 </th>
//               ))}
...
//                     type="checkbox"
//                     checked={
//                       enabledResources[`${res.level}-${res.region}`] || false
//                     }
//                     onChange={(e) =>
//                       onSwitchChange(
//                         `${res.level}-${res.region}`,
//                         e.target.checked
//                       )
//                     }
//                   />
...
//                       value={
//                         manDays[`${res.level}-${res.region}-${i + 1}`] || ""
//                       }
...
//                       value={
//                         quantities[`${res.level}-${res.region}-${i + 1}`] || ""
//                       }
